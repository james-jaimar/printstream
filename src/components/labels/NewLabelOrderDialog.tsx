...
import { SubstrateSelector } from '@/components/labels/SubstrateSelector';
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <SubstrateSelector
                stock={stock?.filter(s => s.is_active) || []}
                value={form.watch("substrate_id")}
                onChange={(val) => form.setValue("substrate_id", val)}
              />
